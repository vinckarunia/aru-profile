            ...
            <div className="max-w-[1280px] mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((service) => (
                        <div
                            key={service.id}
                            className="bg-aru-biru-tua rounded-2xl p-6 group hover:-translate-y-1 transition-all duration-300 hover:shadow-xl cursor-default"
                        >
                            {service.icon && (
                                <span className="material-symbols-outlined text-aru-merah text-4xl mb-4 block">
                                    {service.icon}
                                </span>
                            )}
