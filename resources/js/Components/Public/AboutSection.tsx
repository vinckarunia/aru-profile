    ...
    return (
        <section className="py-20 max-w-[1280px] mx-auto px-6" id="tentang">
            <div className="grid md:grid-cols-2 gap-8 items-start">
                {/* Left - Text */}
                <div>
                    <div className="inline-block bg-aru-biru-muda text-aru-biru-tua px-3 py-1 rounded text-[13px] font-semibold tracking-[0.08em] uppercase mb-4">
                        TENTANG KAMI
                    </div>
                ...
                <div className="bg-aru-biru-muda p-8 rounded-lg border-l-4 border-aru-merah">
                    <h3 className="font-heading font-semibold text-[22px] text-aru-biru-tua mb-4">
                        Visi &amp; Misi
                    </h3>
